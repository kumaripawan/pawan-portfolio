...
export default function BackgroundFX() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      {/* === 2) Rotating conic beam (masked to middle) === */}
      <div
      ...
      {/* === 3) Floating soft blobs (subtle motion) === */}
      <div className="absolute -left-24 top-10 h-[26rem] w-[26rem] rounded-full bg-gradient-to-br from-fuchsia-300/35 via-pink-200/35 to-indigo-300/35 blur-3xl animate-float" />
      <div className="absolute -right-24 top-32 h-[22rem] w-[22rem] rounded-full bg-gradient-to-tr from-amber-200/35 via-rose-200/35 to-pink-200/35 blur-3xl animate-[float_14s_ease-in-out_infinite_alternate]" />

      {/* === 4) Dotted grid overlay === */}
      <svg className="absolute inset-0 opacity-[0.08]" width="100%" height="100%" aria-hidden>
        <defs>
